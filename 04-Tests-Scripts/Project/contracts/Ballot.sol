...
/// @author Encode June Bootcamp Participants
/// @notice You can use this contract to vote on proposals, delegate and show the winning proposal
/// @dev This is a simple ballot contract intended to show what needs to be implemented to make it work on a basic level
/// @custom:encode This is intended to teach Solidity basics for first lesson
contract Ballot {
    /**
    ...
    /// @param proposalNames An array of proposals to vote on
    ...
    /// @param voter The address to give right to vote on proposals
    ...
    /// @param to The address of the voter to delegate to
    function delegate(address to) external {
        ...
        /**
         * @dev Since `sender` is a reference, this
        ...
        if (delegate_.voted) {
            /**
             * @dev If the delegate already voted,
             * directly add to the number of votes
             */
            proposals[delegate_.vote].voteCount += sender.weight;
        } else {
            /**
             * @dev If the delegate did not vote yet,
             * add to her weight.
             */
    ...
    /// @notice Retrieves the index of the winning proposal
    ...
    /// @notice Gives the name of the winning proposal
    /**
     * @dev Calls winningProposal() function to get the index
     * of the winner contained in the proposals array and then
     * returns the name of the winner
     */
    /// @return winnerName_ The winning proposal name
